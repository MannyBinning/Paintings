...
### **Paintings Page:**
- The Paintings page has been kept simple for artist's art only. This page contains 6 Paintings to show the work done by the artist so far. Every painting has been added with popup messeage during mouse hover to show the description of the painting. Once clicked the view button; photo zooms in to concentrate on itself only and in the footer of the modal purchase query has been added with a "Close" button next it. 
### **Material Page:**
...
alt="Paintings-Page wireframe"/>
</p>
<p align="center">
  <img src="assets/images/MaterialPage.png" 
alt="Material-Page wireframe"/>
</p>
<p align="center">
...
The Paintings page consist of no content other than the images and hover over effect to name the paintings. Modal has been added to paintings so users can view the painting with conteration on that particular painting and purchase queries added which takes the user on to contact page once clicked.
This page has been kept simple so the users would be only using the page for its given purpose. 
...
<p align="center">Home Page Overview
  <img src="assets/images/HomePageOverview.png" 
alt="Home-Page"/>
</p>

<p align="center">Painting Page Overview
  <img src="assets/images/PaintingsPageOverview.png" 
alt="Paintings-Page"/>
</p>

<p align="center"> Material Page Overview
  <img src="assets/images/MaterialPageOverview.png" 
alt="Material-Page"/>
</p>
<p align="center">Contact Page Overview
  <img src="assets/images/ContactPageOverview.png" 
alt="Contact-Page"/>
</p>
...
- As a user, I would like to see if i can purchase any paintings. 
...
- As an Artist, I would like the customer to get in touch if they are interested in purchasing any paintings. 
...
- In order for the user to purchase any paintings I have added a modal on paintings which leads on to contact page if interested in purchasing. 
...
When the code was tested there were no errors or warnings other than a typing error in contacts page which was updated accordingly. 
Results for the valdiation are as follow: 
<p align="center">Home Page Validation
  <img src="assets/images/HomePageValidator.png" 
alt="Home-Page Validation"/>
</p>
<p align="center"> Paintings Page Validation
  <img src="assets/images/PaintingsPageValidator.png" 
alt="Paintings-Page Validation"/>
</p>
<p align="center"> Materials Page Validation
  <img src="assets/images/MaterialPageValidator.png" 
alt="Material-Page Validation"/>
</p>
<p align="center"> Contact Page Validation
  <img src="assets/images/ContactPageValidator.png" 
alt="Contact-Page Validation"/>
</p>
<p align="center"> CSS Validation
  <img src="assets/images/CSSValidator.png" 
alt="CSS-Page Validation"/>
</p>
...
Bootstrap was also used for the modal for paintings. 
